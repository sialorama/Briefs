...
class Interface:
    ...
    def saisir_facture(self):
            ...
            def valider():
                #date du jour                
                valide = Connexion.saisie_facture(self.entree_date, self.entree_client, self.entree_facture, self.entree_produit, self.entree_quantite)
            ...
            self.date_facture = self.now.strftime("%d/%m/%Y")
